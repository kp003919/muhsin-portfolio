...
This portfolio showcases a collection of embedded systems, real‑time firmware, and IoT engineering projects I have built using ESP32, STM32, and ARM Cortex‑M microcontrollers.  
Each project demonstrates practical engineering skills including driver development, interrupt handling, FreeRTOS task design, BLE communication, control systems, and hardware‑in‑the‑loop testing.
